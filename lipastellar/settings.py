...
USDC_ISSUER = os.getenv('USDC_ISSUER', 'GA5ZSEJYB37JRC5AVCIA5MOP4RHTM335X2KGX3IHOJAPP5RE34K4KZVN')
FRIENDBOT_URL = os.getenv('FRIENDBOT_URL', 'https://friendbot.stellar.org')
TESTNET_EXPLORER_URL = os.getenv('TESTNET_EXPLORER_URL', 'https://testnet.stellarexpert.com')
